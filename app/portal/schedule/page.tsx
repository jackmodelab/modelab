...
import { BookingCalendar, type CalBooking } from '@/components/booking-calendar';
...
export default async function SchedulePage() {
  ...
  const [{ data: bookings }, { data: clients }, { data: services }, { data: locations }] = await Promise.all([
    supabase
      .from('bookings')
      .select('*')
  ...
  return (
    <>
      ...
      <BookingCalendar bookings={calBookings} />
    </>
  );
}
